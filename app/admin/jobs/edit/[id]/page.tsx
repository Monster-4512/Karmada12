  ...
  return (
    <div className="container py-8 max-w-4xl mx-auto">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Ish e'lonini tahrirlash</h1>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Ish e'loni ma'lumotlarini tahrirlash uchun quyidagi formani to'ldiring</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="isActive">Ish e'loni faol</Label>
            </div>
