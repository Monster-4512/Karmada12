        ...
        <div className="container py-8">
          ...
          <Card>
            <CardContent className="py-10 flex justify-center">
              <p>Kurs ma'lumotlari yuklanmoqda...</p>
            </CardContent>
          </Card>
        </div>
      </div>
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <CardHeader>
              ...
              <CardDescription>Kurs ma'lumotlarini tahrirlang</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="longDescription">Batafsil tavsif</Label>
                <Textarea
                  id="longDescription"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="lessons">Darslar soni</Label>
                  <Input
                    id="lessons"
                    name="lessons"
