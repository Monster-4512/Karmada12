    ...
    try {
      ...
      if (existingUser) {
        ...
        if (!existingUser.active) {
          toast({
            title: "Hisobingiz faol emas",
            description: "Sizning hisobingiz administrator tomonidan o'chirilgan yoki to'xtatilgan",
            variant: "destructive",
          })
          setIsLoading(false)
          return false
        ...
        const userLanguage = sessionStorage.getItem("userLanguage") || localStorage.getItem("language") || "uz"
      ...
      if (username === "admin" && password === "admin123") {
        ...
        const regularUser: Omit<User, "id" | "registeredAt" | "permissions" | "active"> = {
          username: username,
        ...
        const newUser = registerUser(regularUser)
        setUser(newUser)
